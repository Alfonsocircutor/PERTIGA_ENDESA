...
public class DeviceScanActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mBluetoothAdapter == null) {
			...
			Toast toast = Toast.makeText(this, "SELECCIONA DISPOSITIVO", Toast.LENGTH_SHORT);
			toast.show();
		}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (device != null && device.getName() != null){
				...
				//&& device.getName().contains("SensorTag")) {
			final Intent intent = new Intent(this, DetailsActivity.class); //Llamamo a activity con configuration and graphics
			...
			Log.d("Cemitec", String.format("GO TO DETAILS"));
		...
		public void sort() {
			Collections.sort(mLeDevices, new Comparator<BluetoothDevice>() {
				...
				public int compare(BluetoothDevice item1, BluetoothDevice item2) {
					if (item1 != null /*&& item1.getName() != null && item1.getName().equalsIgnoreCase("BlueNRG")*/) {
					//	Log.d("SORT", String.format("GO TO DETAILS"));
						return -1;
					}
